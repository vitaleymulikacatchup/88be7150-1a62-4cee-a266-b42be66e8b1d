...
export const metadata: Metadata = {
  title: "Brewmasters - Premium Coffee & Artisan Roasts",
  description: "Experience exceptional coffee with Brewmasters. Premium beans, expert roasting, and sustainable sourcing for the perfect cup every time.",
  keywords: "premium coffee, artisan roast, coffee beans, espresso, latte, cold brew, coffee subscription",
  metadataBase: new URL("https://brewmasters.com"),
  alternates: {
    canonical: "https://brewmasters.com"
  },
  openGraph: {
    title: "Brewmasters - Premium Coffee & Artisan Roasts",
    description: "Experience exceptional coffee with Brewmasters. Premium beans, expert roasting, and sustainable sourcing for the perfect cup every time.",
    siteName: "Brewmasters",
    images: [
      {
        url: "https://images.pexels.com/photos/7175956/pexels-photo-7175956.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
  ...
  twitter: {
    ...
    title: "Brewmasters - Premium Coffee & Artisan Roasts",
    description: "Experience exceptional coffee with Brewmasters. Premium beans, expert roasting, and sustainable sourcing for the perfect cup every time.",
    images: ["https://images.pexels.com/photos/7175956/pexels-photo-7175956.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
